...
public class InvoiceItemDAO {
	...
	public void topSellingItemWithinASpanOfTime(String startDate, String endDate) throws SQLException {
        ...
        if (rs.next()) {
        	System.out.println();
        	System.out.println("Top selling item within the span of "+startDate+" to "+endDate+" :");
	...
	public void highestSoldProduct(String range, String type) throws SQLException {
        ...
        if (rs.next()) {
        	System.out.println();
        	System.out.println("Product with the highest sales :");
	...
	public void viewUnitsSoldByProductId(int productId) throws SQLException {
        ...
        if (rs.next()) {
        	System.out.println();
            System.out.println("Total Units Sold for item of id "+productId+" is :" + rs.getInt("total_quantity"));
        }
